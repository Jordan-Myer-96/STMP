            ...
            if (user.role === 'host') {
                ...
                if (parsedMessage.type === 'clearChat') {
                    ...
                    try {
                        ...
                        let selected = await db.getAPI(selectedAPI);
                        let [AIResponse, AIChatUserList] = await api.getAIResponse(selected, STBasicAuthCredentials, engineMode, user, userPrompt, liveConfig)
